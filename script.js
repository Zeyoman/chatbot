...
async function respondToUser(userInput) {
    ...
    if (userInput.includes('bonjour') || userInput.includes('hello') || userInput.includes('salut')) {
        ...
        response = 'Toute maladie est soignable, il faut juste garder espoir et se donner les moyens de réussir ce combat. Notre application les heures de kintsugi peux vous aider mentalement et physiquement grâce à nos progammes et professionnel de santé.';
    } else if (userInput.includes('kintsugi')) {
        response = 'Nous sommes une association qui permet au personne ayant une maladie ou des questions d\'être mieux informer et accompagné durant son parcours.';
    } else if (userInput.includes('kintsugi')) {
        response = 'Nous sommes une association qui permet au personne ayant une maladie ou des questions d\'être mieux informer et accompagné durant son parcours.';
